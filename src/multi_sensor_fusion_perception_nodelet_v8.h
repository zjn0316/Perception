// v2,2025/12/11
#ifndef MULTI_SENSOR_FUSION_PERCEPTION_NODELET_V8_H
#define MULTI_SENSOR_FUSION_PERCEPTION_NODELET_V8_H
...
private:
    ...
    geometry_msgs::PointStamped uwb_pt_base_;
    // 计算 UWB 置信度
    ...
    geometry_msgs::PointStamped leg_pt_base_;
    ...
    geometry_msgs::PointStamped zed_pt_base_;
